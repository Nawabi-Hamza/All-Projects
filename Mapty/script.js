...
class Workout{
    ...
    clicks = 0;
    constructor(coords,distance,duratoin){
        this.coords = coords
...
class App{
    ...
    _getPosition(){
        if(navigator.geolocation){
            navigator
                .geolocation
                .getCurrentPosition(this._loadMap.bind(this),this._notFoundPosition)
        }
    }
    _notFoundPosition(){
    ...
    _renderWorkout(workout){
        ...
        // const work = document.querySelectorAll('.workout')
        // console.log(work)
        // work.forEach( w=>
...
// function marker(lat,lng,content,className="running-popup"){
...
//     marker(latitude,longitude,"Current Location")
...
//         // const content = i?'cylicking':'running';
//         // const addClass = i ?'cycling-popup':'running-popup'
//         // marker(lat,lng,content,addClass)
//         // i = !i
//     })
// }
...
//     const content = `${inputType.value==='cycling'?'🚴🏻‍♀️':'🏃🏻‍♂️'}${inputType.value} on ${date}`
//     marker(lat,lng,content,`${inputType.value}-popup`)
// })
